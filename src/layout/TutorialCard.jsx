      ...
      <DialogContentText id="tutorial-card-description" color={'#0D1821'}>
        <Card raised={true}>
          <CardContent>
            ...
            <video src="/slide_tut_1.mp4" autoPlay loop muted playsInline className="w-full rounded-xl" />
          </CardContent>
        </Card>
        <br />
        <Card raised={true}>
          <CardContent>
            ...
            <div className="h-3"></div>
            <video src="/slide_tut_2.mp4" autoPlay loop muted playsInline className="w-full rounded-xl" />
            <div className="h-3"></div>
        ...
        <Card raised={true}>
          <CardContent>
            ...
            <br />
            {/* Answer the clue, just like a crossword. */}
            <div className="h-3"></div>

            <video src="/slide_tut_show_clue.mp4" autoPlay loop muted playsInline className="w-full rounded-xl" />
          </CardContent>
        </Card>
        ...
        <Card raised={true}>
          <CardContent>
            <span className="">In this case, the clue is "Color of the sky" and the answer is BLUE</span>
            <div className="h-3"></div>

            <video src="/slide_tut_solve_blue.mp4" autoPlay loop muted playsInline className="w-full rounded-xl" />
          </CardContent>
        </Card>
        <br />
        <br />
        <Card raised={true}>
          <CardContent>
            ...
            <video src="/slide_tut_next_clue.mp4" autoPlay loop muted playsInline className="w-full rounded-xl" />
          </CardContent>
        </Card>
        <br />
        <br />
        ...
        <Card raised={true}>
          <CardContent>
            ...
            <video src="/slide_tut_solve_oust.mp4" autoPlay loop muted playsInline className="w-full rounded-xl" />
            <div className="h-3"></div>
        ...
        <Card raised={true}>
          <CardContent>
            ...
            <video src="/slide_tut_solve_nada.mp4" autoPlay loop muted playsInline className="w-full rounded-xl" />
            <div className="h-3"></div>
        ...
        <Card raised={true}>
          <CardContent>
            ...
            <video src="/slide_tut_endgame.mp4" autoPlay loop muted playsInline className="w-full rounded-xl" />
            <div className="h-3"></div>
