export const puzzles = {
    ...
    biggies: [
        ...
        ,
        {
            ...
            clues: {
                across: [
                    "Princess's irritant in a classic fairy tale",
                    '___ Angeles',
                    'Q-tip, e.g.',
                    'Alternative to straight up, at a bar',
                    'Read closely, with "over"',
                    'South American predator whose name translates to "tooth fish"',
                    'Dutch ___ (heavy pot)',
                    'Sandwich top',
                    '"Atlas Shrugged" author Rand',
                    'Gallery display',
                    'Up to, for short',
                    'Indian garment that drapes',
                    'Added coins to, as a parking meter',
                    'French female friend',
                    'Iconic hairstyle for Amy Winehouse',
                    'Fruity sandwich ingredient',
                    'Get by coercion ',
                    'Pet for Fred, Wilma and Pebbles',
                    'Racing org. for Dale Earnhardt',
                    `"Huh, didn't see you there!"`,
                    'Humiliated',
                    'Savory sandwich ingredient',
                    'Shelfmate of Aleve and Advil',
                    'Therefore',
                    "NNW's opposite",
                    'Blueprint detail, in brief',
                    'Xfinity or Verizon Fios, in brief',
                    'One of 100 in D.C.',
                    'Penguin lookalike',
                    'Sandwich bottom',
                    `Jimi Hendrix's "Purple ___" `,
                    `Set of books like Elie Wiesel's "Night," "Dawn" and "Day"`,
                ...
                down: [
                    ...
                    'Wicked',
                    'Trapeze artist',
                    'Closet items like sheets and towels',
                    'Eight, in Spanish',
                    'Ocean voyager',
                    'Hurling, curling or baton twirling',
                    'Worked at a loom',
                    'Square footage',
                    'Reshape, as a pipe cleaner',
                    'Somewhat R-rated',
                    'Prickly plant in a thicket',
                    'Reset button on a scale',
                    'Immersive cinema format',
                    'Helps with a heist, say',
                    'Island country west of Tonga',
                    `Broadway's "Dear ___ Hansen"`,
                    "Store item that's only for show",
                    '"On My Own" singer in "Les Misérables"',
                    'Drink enough water',
                    'Garment with two cups',
                    'Alternative to broadcast TV',
                    '___ Dhabi ',
                    'Chooses (to)',
                    'Casual greetings',
                    'Strong and healthy',
                    "Whiff three times in the batter's box",
                    'Readouts of brain waves, in brief',
                    '___-down menu',
                    `"I can't ___ that!" (lament after encountering a disturbing image)`,
                    'The very best',
                    'Lakeside lodgings',
                    'Part of an act ',
                    '"www" addresses',
